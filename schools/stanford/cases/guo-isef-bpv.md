# Stanford Case Study — guo-isef-bpv
...
| 性别 | 男（基于公开姓名与学校上下文推定，非核心判断） |
| 族裔 | 未公开 |
| First-generation | 未公开 |
| Legacy | 未公开 |
| Recruited Athlete | 否 |
...
- 2025 Regeneron ISEF, **Environmental Engineering Third Award** ($1,200)
- Team Canada member at Regeneron ISEF 2025

## 课外活动（Extracurriculars）

### 1. ISEF 环境工程团队项目（核心活动）
- 与 Veronica (Yu Han) Guo 共同完成项目：
  **Dual-Purpose Biological Photovoltaic: Optimizing Power Output and Wastewater Treatment**
- 项目同时涉及生物光伏（biophotovoltaic）与废水处理，体现出明显的跨学科工程 / 环境方向
- 已由 Society for Science 与 Youth Science Canada 公开结果页双重支持

### 2. 校内公开活动信号
- 学校公开页显示其为 **St. George’s School ‘26**
- Google 收录摘要显示其曾出现在学校 athletic alternate 名单中，可视为校内持续参与的辅助信号

### 3. Science communication / club 信号
- 公开网页摘要显示其与 **Scientific Journalism Club** 存在关联
- 该条可作为辅助活动线索，但不作为核心亮点使用

### Summer Program
- 未公开

### Research
- 环境工程 / 生物光伏方向团队研究，公开结果已达 ISEF 奖项级别

## 可提炼的申请画像（What likely mattered）
